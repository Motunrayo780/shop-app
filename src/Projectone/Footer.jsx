      ...
      <div className='bg-slate-500 w-full h-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 items-start text-white py-8 px-6'>
        <div className='w-full md:w-[300px] text-gray-300'>
          ...
          <ul className="space-y-1">
            ...
            <li><a href="/affiliate-program" className="text-gray-300 hover:text-white">Affiliate Program</a></li>
          </ul>
        </div>
        ...
        <div className='w-full md:w-[300px] text-gray-300'>
          ...
          <ul className="space-y-1">
            ...
            <li><a href="/order-tracking" className="text-gray-300 hover:text-white">Order Tracking</a></li>
            <li><a href="/shipping-delivery" className="text-gray-300 hover:text-white">Shipping & Delivery</a></li>
            <li><a href="/returns-refunds" className="text-gray-300 hover:text-white">Returns & Refunds</a></li>
        ...
        <div className='w-full md:w-[300px] text-gray-300'>
          ...
          <ul className="space-y-1">
            <li><a href="/best-sellers" className="text-gray-300 hover:text-white">Best Sellers</a></li>
            ...
            <li><a href="/discounts-offers" className="text-gray-300 hover:text-white">Discounts & Offers</a></li>
            <li><a href="/find-a-store" className="text-gray-300 hover:text-white">Find a Store</a></li>
          </ul>
        </div>
      </div>
