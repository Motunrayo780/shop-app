    ...
    <nav className="bg-slate-800 text-white">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-slate-800">
          <div className="flex flex-col items-center space-y-4 py-4 border-t border-gray-700">
            <a href="/" className="hover:text-gray-400">Home</a>
            <a href="/shop" className="hover:text-gray-400">Shop</a>
            <a href="/categories" className="hover:text-gray-400">Categories</a>
            <a href="/sale" className="hover:text-gray-400">Sale</a>
          ...
          <div className="flex justify-center space-x-8 py-4 border-t border-gray-700">
